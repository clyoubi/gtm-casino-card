...
<?php 
    $general_bg_color = GTM_Setting::getSetting("casino_card","casino_general_logo_background", "#000");
    $general_cta_bg_color = GTM_Setting::getSetting("casino_card", "casino_general_cta_color", "#287e29");
?>
<div class="wrap">
    ...
    <table class="table" id="info">
        ...
        <tbody>
            <tr>
                <td><strong>id</strong>
                    <?php if(GTM_Setting::getSetting("casino_card", "casino_general_fetch_all_casinos") !== 'yes') : ?> 
                        <i>(required)</i>
                    <?php endif; ?>
                </td>
            ...
            <tr>
                ...
                <td><code>[casino_card cta_color="#287e29"]</code></td>
            </tr>
            <tr>
